...
#CancerSite <- 'CHOL'
print(CancerSite)
TargetDirectory <- paste0("C:/Users/giordano/Trabalho/2019-2022/Doutorado/Development/ws-modmap/Input_Data/miRNAseq/")
directories <- Download_TCGA_data(CancerSite, TargetDirectory,data = 'miRseq')
assign(paste0(CancerSite,'_Data'),Preprocess_miRNAseq(CancerSite, 
directories,lg=F, mvt = 0.2, bct='limma',normal=T,svtmp = 'C:/Users/giordano/')) 
save(list = c(paste0(CancerSite,'_Data')),
    file=paste0('C:/Users/giordano/Trabalho/2019-2022/Doutorado/Development/ws-modmap/PreProccesed_Data/miRseq/',
